...
```typescript
const chatModel = openai.chatModel("gpt-4-turbo-preview", {
...
```typescript
const embeddingModel = openai.embeddingModel("text-embedding-3-large", {
  apiKey: "your-api-key-here",                              // required
  organization: "your-openai-business-organization",        // optional
});
```
...
const model = openai.embeddingModel("text-embedding-3-large", {
  apiKey: "your-api-key",
});
const gatewayRequest = model.transformModelRequest(openAiRequest)
